...
function handleMouseOver(d, i) {  // Add interactivity
	...
	arcs.append("text")
	  .data(pie(cars))
	  //.attr({id: "t" + function(d){return d.data.capacity}})  // Create an id for text so we can select it later for removing on mouseout
	   .attr("transform", function(d) { return "translate(" + outerArc.centroid(d) + ")";  })
	  .text(function(d) {
	    return [d.data.capacity];  // Value of the text
	  });
  }
